...
namespace Grocery.App
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddSingleton<IAuthService, AuthService>(); // is nu werkende code.
            ...
            builder.Services.AddTransient<LoginView>().AddTransient<LoginViewModel>();// is nu werkende code.
